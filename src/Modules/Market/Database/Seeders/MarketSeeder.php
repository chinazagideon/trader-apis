    ...
    public function run(): void
    {
        $markets = [
            ...
            [
                'name' => 'US Dollar',
                'symbol' => 'USD',
                'description' => 'US Dollar is the official currency of the United States. It is based on the US dollar and is not controlled by any central authority.',
                'image' => 'https://assets.coingecko.com/coins/images/3128/large/usd.png?1696501628',
                'url' => 'https://www.usdollar.com',
                'slug' => 'usd',
                'status' => 'active',
            ],
            [
                'name' => 'Euro',
                'symbol' => 'EUR',
                'description' => 'Euro is the official currency of the European Union. It is based on the Euro and is not controlled by any central authority.',
                'image' => 'https://assets.coingecko.com/coins/images/3128/large/usd.png?1696501628',
                'url' => 'https://www.euro.com',
                'slug' => 'eur',
                'status' => 'active',
                'type' => 'spot',
                'category' => 'fiat',
            ...
            [
                'name' => 'British Pound',
                'symbol' => 'GBP',
                'description' => 'British Pound is the official currency of the United Kingdom. It is based on the British Pound and is not controlled by any central authority.',
                'image' => 'https://assets.coingecko.com/coins/images/3128/large/usd.png?1696501628',
                'url' => 'https://www.gbp.com',
                'slug' => 'gbp',
                'status' => 'active',
                'type' => 'spot',
                'category' => 'fiat',
