...
<body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
    ...
    <div style="background-color: #4F46E5; color: white; padding: 20px; text-align: center; border-radius: 5px 5px 0 0;">
        <img src="https://www.shutterstock.com/image-vector/google-icon-made-manually-based-600w-2317500299.jpg" alt="Logo" style="width: 100px; height: 100px;">
    ...
    <div style="text-align: center; padding: 20px; color: #6b7280; font-size: 12px;">
        <p style="margin: 5px 0;">© {{ date('Y') }} Your Company. All rights reserved.</p>
    </div>
